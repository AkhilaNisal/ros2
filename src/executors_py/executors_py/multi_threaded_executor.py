...
class Node2(Node):
    def __init__(self):
        ...
        self.timer1_ = self.create_timer(
            1.0, self.callback_timer4, callback_group= self.cb_group2_)
        self.timer2_ = self.create_timer(
            1.0, self.callback_timer5, callback_group= self.cb_group2_)
        self.timer3_ = self.create_timer(
            1.0, self.callback_timer6, callback_group= self.cb_group2_)
